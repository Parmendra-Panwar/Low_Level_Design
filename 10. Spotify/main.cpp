#include "MainPlayerApplication.hpp"
...
int main() {
    try {
        ...
        // Populate library
        application->createSongInLibrary("Kesariya", "/music/kesariya.mp3");
        application->createSongInLibrary("Chaiyya Chaiyya", "/music/chaiyya_chaiyya.mp3");
        application->createSongInLibrary("Tum Hi Ho", "/music/tum_hi_ho.mp3");
        application->createSongInLibrary("Jai Ho", "/music/jai_ho.mp3");
        application->createSongInLibrary("Zinda", "/music/zinda.mp3");
